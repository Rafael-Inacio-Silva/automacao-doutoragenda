...
def get_browser_contexts() -> typing.Generator[T_JSON_DICT,T_JSON_DICT,typing.Tuple[typing.List[
    browser.BrowserContextID], typing.Optional[browser.BrowserContextID]]]:
    '''
