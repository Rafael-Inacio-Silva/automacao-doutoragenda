...
from backend.acoes_menu_trocar_tenant.analisador_tenant import analisar_tenant
from backend.acoes_menu_trocar_tenant.fechar_caixa_busca_tenant import fechar_modal_tenant
